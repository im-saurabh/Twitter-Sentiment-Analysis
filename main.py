...
def sentiment():
    ...
    consumerKey = "x7dTt0YMgUb9GS1MF5pSifc4Z"
    consumerSecret = "K3TCA2vY3rp7NopY2QnMRTRIVRCCR6wS73zNfECsUoo8pXR5Ms"
    accessToken = "1238852646565376000-R8F2MgJkD2gwwONeiTcwReV0vDRN7z"
    accessTokenSecret = "1ZzpoMuruKpTGVFRKKB7muOHksAeolCWRxIDFx0AzB1zO"
    ...
    if userid == "":
        ...
        return render_template('sentiment.html', name=hashtag, positive=positive_per, negative=negative_per,
                               neutral=neutral_per)
    else:
        # user coding
        username = "@" + userid
        ...
        return render_template('sentiment.html', name=username, positive=positive_per, negative=negative_per,
                               neutral=neutral_per)
